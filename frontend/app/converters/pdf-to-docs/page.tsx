...
export default function PdfToDocsPage() {
  ...
  const uploadAndDownload = async (file: File) => {
    ...
    try {
      const response = await fetch("http://127.0.0.1:8000/api/pdf-to-docx/", {
        method: "POST",
        body: formData,
      });
      ...
      <div className="max-w-2xl w-full">
        <div className="mb-6">
          ...
          <p className="mt-1 text-sm text-gray-600">
            Upload a PDF and download a converted Word document. Files are sent to your backend at{" "}
            <code className="bg-gray-100 px-1 rounded">/api/convert-pdf/</code>.
          </p>
        </div>
